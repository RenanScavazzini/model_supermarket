...
def display_charts(df: pd.DataFrame) -> None:
    ...
    fig_periodo = px.bar(df_periodo, x='periodo_dia', y='preco_total', labels={'preco_total': 'Gasto Total', 'periodo_dia': 'Período'})
    st.plotly_chart(fig_periodo, use_container_width=True)

    fig_supermercado = px.bar(df_supermercado, x='supermercado', y='preco_total', labels={'preco_total': 'Gasto Total', 'supermercado': 'Supermercado'})
    st.plotly_chart(fig_supermercado, use_container_width=True)

    fig_produto = px.bar(df_produto, x='produto', y='preco_total', labels={'preco_total': 'Gasto Total', 'produto': 'Produto'})
